...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "ecrecana@gmail.com",
    href: "mailto:ecrecana@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: "success",
        message: "Message sent successfully! I'll get in touch soon.",
      });
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                Whether you need a full-time Senior QA Analyst or a AI automation,
                let's talk!
              </p>
            </div>
          </div>
